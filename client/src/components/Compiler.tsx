...
import { buildSpriteXml, extractSymbolsFromSprite, sortSymbolsById } from "../utils/buildDemo";
import { copyToClipboard } from "../utils/buildDemo";
import CompilerHeader from "./helpers/CompilerHeader";
import ExistingSpriteSection from "./helpers/ExistingSpriteSection";
import FileDropzone from "./helpers/FileDropzone";
import GenerateButton from "./helpers/GenerateButton";
import InlineSaveSection, { type InlineSaveValue } from "./helpers/InlineSaveSection";
import LibraryPanel from "./helpers/LibraryPanel";
import LiveDemoModal, { type CopiedIcon, type LiveDemoCssState } from "./helpers/LiveDemo";
import type { Source as LiveDemoSource } from "./helpers/LiveDemo";
import PasteIconsModal from "./helpers/PasteIconsModal";
import SaveToLibraryModal from "./helpers/SaveToLibraryModal";
import IconConflictModal from "./helpers/IconConflictModal";
import type { ConflictResolution, IconConflict } from "../hooks/useSpriteCompiler";
import SelectFromLibraryModal from "./helpers/SelectFromLibraryModal";
import { buildDemoHtml } from "../utils/buildDemo";
...
import ModeTabs, { type CompilerMode } from "./helpers/ModeTabs";
import ResultsPanel from "./helpers/ResultsPanel";
import StagedFilesList from "./helpers/StagedFilesList";
import UserGuidePanel from "./helpers/UserGuidePanel";
